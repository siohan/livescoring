...
$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_livescoring_lives" );
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_livescoring_rencontres" );
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_livescoring_parties" );
$dict->ExecuteSQLArray($sqlarray);
